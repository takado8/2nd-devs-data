...
from data_processing.law_articles_extractor import MAX_TOKENS
...
def law_extractor2(input_string):
...
def split_longer_articles(articles):
    ...
    points = re.split(pattern, articles)
...
if __name__ == '__main__':
    with open('../data/txt/pzp.txt', 'r', encoding='utf-8') as file:
        text = file.read()
    # print(text)
    result = law_extractor2(text)
    with open("../data/newwtest.json", 'w+') as f:
        json.dump(result, f)
